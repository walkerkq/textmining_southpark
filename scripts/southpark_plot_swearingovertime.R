...
mycolors <- c("#C20631", "#673e1e", "#5BE1C6", "#F5871F", "#333333","#266E35")
ggplot(swearing, aes(variable, value)) + geom_line(aes(color=word)) + 
    ...
    annotate("text", x=66, y=132, label="0501: It Hits the Fan", size=5, color="#266E35") +
    annotate("text", x=15, y=39, label="0109: Mr. Hankey,\nthe Christmas Poo", size=5, color="#673e1e") + 
    annotate("text", x=220, y=35, label="1507: You're Getting Old", size=5, color="#266E35") +
    annotate("text", x=90, y=47, label="0409: Do the Handicapped Go to Hell?", size=5, color="#333333") + 
    annotate("text", x=63, y=42, label="0410: Probably", size=5, color="#333333") +
    annotate("text", x=161, y=30, label="1108: Le Petit Tourette", size=5, color="#C20631") + 
    theme_classic() + 
