...
########################
# R script to explore the ngram sets, describe the data sets and display log likelihood results visually.
########################
...
### southpark_tdm.csv
### southpark_bi_tdm.csv
### southpark_tri_tdm.csv
### southpark_quad_tdm.csv
### southpark_quint_tdm.csv
########################
# Output: 
### southpark_wordcloud_unigrams.png
### southpark_wordcloud_bigrams.png
### southpark_wordcloud_trigrams.png
### southpark_talksalot_plot.png
### southpark_swearsalot_plot.png
...
##### THE CARTMAN-IEST WORDS: Find the most characteristic words/phrases per person
